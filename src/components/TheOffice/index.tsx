                ...
                <div className="container">
                    ...
                    <Paragraph className="fs-2">
                        <p>
                            ...
                            melhor solução para seus conflitos.
                        </p>
                    </Paragraph>
                    <Paragraph className="fs-2">
                        <p>
                            Sabemos que são em momentos difíceis que a
                            necessidade de uma advogado se faz presente, por
                            isso objetivamos prestar o atendimento jurídico da
                            forma mais humana e responsável possível.
                        </p>
                    </Paragraph>
                    <Paragraph className="fs-2">
                        <p>
                            ...
                            financeiro, como também o emocional, psicológico e
                            social.
                        </p>
                    </Paragraph>
                </div>
